...
class IssuingAuthority extends StatelessWidget {
  IssuingAuthority({super.key});

  final controller = Get.put(IssuingAuthorityController());
      ...
      body: Obx(() => controller.isLoading.value
          ...
          : Column(
              children: [
                ...
                Text(
                  "-------   Tổng số cơ quan ban hành: ${controller.totalCount.value}   -------",
                ...
                _actionItem(
                    ...
                    onTap: () {
                      CustomDialog.show(
                          ...
                          content:
                              "Cơ quan ban hành '${controller.collection[index].name}' sẽ bị xóa, bạn chắc chứ?");
                    }),
              ],
