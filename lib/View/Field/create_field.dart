import 'package:edocflow/Controller/Field/create_field_controller.dart';
...
class CreateField extends StatelessWidget {
  CreateField({super.key});

  final controller = Get.put(CreateFieldController());
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        _titleForm(title: "Tên lĩnh vực", isRequired: true)
